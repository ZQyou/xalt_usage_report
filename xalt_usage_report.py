...
class CmdLineOptions(object):
  ...
  def execute(self):
    ...
    parser.add_argument("--sql",     dest='sql',       action="store",       default = None,           help="sql search pattern used with --module and --execrun")
    ...
    parser.add_argument("--gpu",     dest='gpu',       action="store_true",                            help="report module/exec usage wit num_gpus > 0")
