equiv_patternA = [
    ...
    [ r'^g09'                      , 'Gaussian'                 ],
    [ r'^g16'                      , 'Gaussian'                 ],
    [ r'^l1[0-9][0-9].exe'         , 'Gaussian'                 ],
    [ r'^l4[0-9][0-9].exe'         , 'Gaussian'                 ],
    [ r'^l5[0-9][0-9].exe'         , 'Gaussian'                 ],
    [ r'^l7[0-9][0-9].exe'         , 'Gaussian'                 ],
    [ r'^l1110.exe'                , 'Gaussian'                 ],
    [ r'^l9999.exe'                , 'Gaussian'                 ],
    [ r'^pmemd'                    , 'Amber'                    ],
    [ r'^sander'                   , 'Amber'                    ],
    [ r'^relax.default.linuxgccrelease', 'Rosetta'              ],
    [ r'^simpleFoam'               , 'OpenFORM'                 ],
]
